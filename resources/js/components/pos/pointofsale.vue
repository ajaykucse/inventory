            ...
            <div class="col-xl-5 col-lg-5">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary float-left">Expense Insert</h6>
                  <a class="m-0 float-right btn btn-sm btn-info btn-sm float-right"><font color="#FFFFFF">Add Customer</font></a>
                </div>

                <div class="table-responsive" style="font-size:7.3px;">
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="cart in carts" :key="cart.id">
                        <td>{{ cart.pro_name }}</td>
                        <td>
                          <input type="text" :value="cart.pro_qty" readonly="" style="width: 15px;">
                        ...
                        <td><a @click="removeItem(cart.id)" class="btn btn-primary btn-sm"><font color="#FFFFFF">x</font></a></td>
                      </tr>
        ...
        <!--Category Wise Product -->
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <input type="text" v-model="searchTerm" class="form-control" placeholder="Search..." style="width:366px; margin-bottom: 5px;">
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-16" v-for="product in filtersearch" :key="product.id">
                      <button class="btn btn-sm" @click.prevent="AddToCart(product.id)">
                      <div class="card" style="width: 7.5rem; margin-bottom: 5px;">
                      <img :src="product.image" id="pro_img" class="card-img-top">
                      <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <input type="text" v-model="searchTerm" class="form-control" placeholder="Search..." style="width:366px; margin-bottom: 5px;">
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-16" v-for="getproduct in getfiltersearch" :key="getproduct.id">
                      <button class="btn btn-sm" @click.prevent="AddToCart(getproduct.id)">
                      <div class="card" style="width: 7.5rem; margin-bottom: 5px;">
                      <img :src="getproduct.image" id="pro_img" class="card-img-top">
                      <div class="card-body">
  ...
  export default {
    ...
    computed:{
      ...
      subtotal(){
        let sum = 0;
        for (let i = 0; i< this.carts.length; i++) {
          sum += (parseFloat(this.carts[i].pro_qty) * parseFloat(this.carts[i].pro_price));
        }
        return sum;
      },
    },
