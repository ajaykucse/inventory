                ...
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="customerUpdate" enctype="multipart/form-data">
                    <div class="form-group">
	                    <div class="form-row">
                          ...
                          <label for="exampleFormControlSelect1"><b>Customer Name</b></label>
	                    	...
	                    	<div class="col-md-6">
                          <label for="exampleFormControlSelect1"><b>Customer E-mail</b></label>
                    ...
                    <div class="form-group">
	                    <div class="form-row">
	                    	<div class="col-md-6">
                          <label for="exampleFormControlSelect1"><b>Customer Address</b></label>
                        ...
                        <div class="col-md-6">
                          <label for="exampleFormControlSelect1"><b>Customer Phone</b></label>
